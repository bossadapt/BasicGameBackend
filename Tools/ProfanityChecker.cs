...
//https://github.com/stephenhaunts/ProfanityDetector/tree/main
public class ProfanityChecker{
        ...
        public bool ContainsProfanity(string term)
        {
            ...
            List<string> potentialProfanities = _wordList.Where(word => word.Length <= term.Length).ToList();
